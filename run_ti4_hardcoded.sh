...
BENCH_OUT="${BENCH_OUT:-results/hardcoded_decompositions_ti4.csv}"
FAIL_OUT="${FAIL_OUT:-results/hardcoded_decomposition_failures_ti4.csv}"
REPETITIONS="${REPETITIONS:-1}"
TIME_LIMIT="${TIME_LIMIT:-100s}"
